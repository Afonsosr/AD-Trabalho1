...
public class GPCRMIServer {
    public static void main(String[] args) {
        try {
            ...
            medicacao6.add("Paracetamol");
            medicacao6.add("Ibuprofeno");
            ArrayList<String> condicoes6 = new ArrayList<>();
            condicoes6.add("Febre");
            condicoes6.add("Dor de cabeça");
            ...
            medicacao7.add("Insulina");
            medicacao7.add("Metformina");
            ArrayList<String> condicoes7 = new ArrayList<>();
            condicoes7.add("Diabetes Tipo 2");
            ...
            medicacao8.add("Omeprazol");
            ArrayList<String> condicoes8 = new ArrayList<>();
            condicoes8.add("Refluxo gástrico");
            ...
            medicacao9.add("Cetirizina");
            ArrayList<String> condicoes9 = new ArrayList<>();
            condicoes9.add("Alergia sazonal");
...
//            System.out.println(gut.totalUtentes());
            ...
            APIGestorUtentes ut = (APIGestorUtentes) Naming.lookup("rmi://localhost:50001/GUT");
            System.out.println("Utentes total: " + ut.totalUtentes());
